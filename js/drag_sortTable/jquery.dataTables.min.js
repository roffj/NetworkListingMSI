...
(function(h) {
    ...
    function la(a, b, c) {
        ...
        b.sSortingClassJUI = d.sSortJUIAscAllowed) : !a && c ? (b.sSortingClass = 
        d.sSortableDesc,
                ...
                for (g = q.length; f < g; f++)
                    if ("number" === typeof q[f] && 0 <= q[f]) {
                        ...
                        for (i = l.length; j < i; j++)
                            ("_all" == q[f] || h(l[j].nTh).hasClass(q[f])) && d(j, o)
                    }
            }
        if (c) {
            e = 0;
    ...
    function Ka(a, b, c, d) {
        ...
        , S = function(a) {
            ...
            c === i)
                ...
                j && j._bAttrSrc ? (R(j.mData._)(d, o),
                u(j.mData.sort, a),
                u(j.mData.type, a),
                u(j.mData.filter, a)) : q ? (j._setter || (j._setter = R(j.mData)),
                j._setter(d, o)) : d[i] = o;
            i++
        }
        ;
        ...
        if (-1 !== h.inArray(!1, b))
            ...
            if (0 !== i.length) {
                ...
                for (j = j ? 0 : g; j < f; j++) {
                    ...
                    if (0 !== e) {
                        var u = d[c % e];
                        q._sRowStripe != u && (h(l).removeClass(q._sRowStripe).addClass(u),
                        q._sRowStripe = u)
                    }
        ...
        for (var f = a.sDom.split(""), g, j, i, o, l, q, u = 0; u < f.length; u++) {
            ...
            if ("<" == j) {
                ...
                if ("'" == o || '"' == o) {
                    ...
                    i.className = o[1]) : "#" == l.charAt(0) ? i.id = l.substr(1, l.length - 1) : i.className = l;
                    u += q
                }
                e.append(i);
                e = h(i)
    ...
    function ra(a, b, c) {
        ...
        a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) {
            ...
            url: g || a.sAjaxSource
        })) : h.isFunction(g) ? a.jqXHR = g.call(j, b, i, a) : (a.jqXHR = h.ajax(h.extend(o, g)),
        g.data = f)
    }
    function lb(a) {
    ...
    function ub(a) {
        ...
        for (g = 0; g < c; g++)
            ...
            k("bSearchable_" + g, o.bSearchable)),
    ...
    function Ha(a) {
        ...
        if (d || !u && !f && !e && j == ca(a) && j == o.length)
            ...
            for (m = 0; m < i.length; m++)
                n = c[i[m]],
                o[m].style.width = null  !== n.sWidthOrig && 
                "" !== n.sWidthOrig ? w(n.sWidthOrig) : "",
            ...
            j.removeAttr("width"),
            j.width() < k.clientWidth && l && j.width(k.clientWidth)) : e ? j.width(k.clientWidth) : 
            l && j.width(l);
    ...
    m = function(a) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                e.sDom === l.sDom && "lfrtip" === l.sDom && (n.sDom = '<"H"lfr>t<"F"ip>'),
                n.renderer) ? h.isPlainObject(n.renderer) && !n.renderer.header && (n.renderer.header = "jqueryui") : n.renderer = "jqueryui" : h.extend(i, m.ext.classes, e.oClasses);
                q.addClass(i.sTable);
                n.iInitDisplayStart === k && (n.iInitDisplayStart = e.iDisplayStart,
                n._iDisplayStart = e.iDisplayStart);
                null  !== e.iDeferLoading && (n.bDeferLoading = !0,
                g = h.isArray(e.iDeferLoading),
                n._iRecordsDisplay = g ? e.iDeferLoading[0] : e.iDeferLoading,
                n._iRecordsTotal = g ? e.iDeferLoading[1] : e.iDeferLoading);
                var t = n.oLanguage;
                ...
                Kb(n, e),
                z(n, "aoDrawCallback", ya, "state_save"));
                if (e.aaSorting === k) {
                    u = n.aaSorting;
                    g = 0;
                    for (j = u.length; g < j; g++)
                ...
                0 === j.length || 0 === j.children().length ? q.addClass(i.sNoFooter) : 0 < j.length && (n.nTFoot = j[0],
                fa(n.aoFooter, n.nTFoot));
                if (e.aaData)
                    for (g = 0; g < e.aaData.length; g++)
                        N(n, e.aaData[g]);
                else
                    (n.bDeferLoading || "dom" == y(n)) && ma(n, h(n.nTBody).children("tr"));
